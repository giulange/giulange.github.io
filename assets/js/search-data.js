...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A curated collection of current and past research and development projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "teaching",
          description: "Teaching activities and courses held by Prof. Giuliano Langella, Associate Professor of Pedology and Pedoinformatics at the University of Naples Federico II, and collaborator in advanced training programs at the University of Padua.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-agrimetsupport",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%67%69%75%6C%69%61%6E%6F.%6C%61%6E%67%65%6C%6C%61@%75%6E%69%6E%61.%69%74", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/giulange", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/giuliano-langella-unina", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-7210-0906", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=FEHeQ4kAAAAJ", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
        section: 'Socials',
        handler: () => {
          window.open("https://www.scopus.com/authid/detail.uri?authorId=57191951108", "_blank");
        },
      },{
        id: 'social-telegram',
        title: 'telegram',
        section: 'Socials',
        handler: () => {
          window.open("https://telegram.me/giulange", "_blank");
        },
      },{
        id: 'social-whatsapp',
        title: 'whatsapp',
        section: 'Socials',
        handler: () => {
          window.open("https://wa.me/393473171308", "_blank");
        },
      },{
      id: 'light-theme',
